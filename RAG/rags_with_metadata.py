...
# Check id the Chroma vector already exists
if not os.path.exists(persistent_directory):
    print("Persistent directory doesnot exist. Initializing vector store...")
    ...
    #Display information anout the split documents
